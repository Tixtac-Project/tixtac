  ...
  export const buttonVariants = tv({
    ...
    variants: {
      ...
      size: {
        ...
        sm: "h-8 gap-1.5 rounded-[min(var(--radius-lg),12px)] px-3 text-sm in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-2.5 has-data-[icon=inline-start]:pl-2.5 [&_svg:not([class*='size-'])]:size-3.5",
